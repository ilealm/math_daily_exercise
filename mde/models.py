...
class User(db.Model, UserMixin):
    ...
    parent_email_address = db.Column(
        db.String(length=50), nullable=True, default=None)
    ...
    # Fun. that updates the user's games_played, right_answers, last_played according the last played game
